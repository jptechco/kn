...
- (NSData *)decodeBase64WithNewlines:(BOOL)encodedWithNewlines {
	//the newline flag is no longer meaningful: unknown characters (line breaks among them) are always
	//skipped, which matches how forgiving the OpenSSL BIO decoder this replaced was in both modes
	(void)encodedWithNewlines;
